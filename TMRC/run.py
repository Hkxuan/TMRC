...
from algorithm.tmrc import ACORM_Agent
...
class Runner:
    def __init__(self, args):
        ...
        self.writer = SummaryWriter(
            log_dir='./result/tb_logs/{}/{}/{}_seed_{}_{}'.format(self.args.algorithm, self.env_name, self.env_name,
                                                                  self.seed, time_path))
        ...
        self.args.recl_pretrain_epochs = 0  # 100
    ...
    def evaluate_policy(self, ):
        ...
        # if win_rate > 0.96:
        #     model_path = f'{self.model_path}/{self.env_name}_seed{self.seed}_step{self.total_steps}_'
        #     torch.save(self.agent_n.eval_Q_net, model_path + 'q_net.pth')
        #     torch.save(self.agent_n.RECL.role_embedding_net, model_path + 'role_net.pth')
        #     torch.save(self.agent_n.RECL.agent_embedding_net, model_path + 'agent_embed_net.pth')
        #     torch.save(self.agent_n.eval_mix_net.attention_net, model_path + 'attention_net.pth')
    ...
    def initial_parm(self):
        self.agent_n.eval_Q_net.load_state_dict(torch.load('model/acorm/MMM2_seed4_step2760044_q_net.pth').state_dict())
        self.agent_n.eval_mix_net.attention_net.load_state_dict(torch.load('model/acorm/MMM2_seed4_step2760044_attention_net.pth').state_dict())
        self.agent_n.eval_mix_net.load_state_dict(torch.load('model/acorm/MMM2_seed4_step2760044_mix_net.pth').state_dict())
        self.agent_n.RECL.role_embedding_net.load_state_dict(torch.load('model/acorm/MMM2_seed4_step2760044_role_net.pth').state_dict())
        self.agent_n.RECL.agent_embedding_net.load_state_dict(torch.load('model/acorm/MMM2_seed4_step2760044_agent_embed_net.pth').state_dict())

        self.agent_n.target_Q_net.load_state_dict(torch.load('model/acorm/MMM2_seed4_step2760044_q_net.pth').state_dict())
        self.agent_n.target_mix_net.load_state_dict(torch.load('model/acorm/MMM2_seed4_step2760044_mix_net.pth').state_dict())