...
if __name__ == '__main__':
    ...
    parser.add_argument("--evaluate_times", type=float, default=32, help="Evaluate times")  #32
    ...
    parser.add_argument("--batch_size", type=int, default=32, help="Batch size (the number of episodes)")  #32
    ...
    # attention
    parser.add_argument("--role_att_dim", type=int, default=128, help="The dimension of the attention net")
    ...
    parser.add_argument("--state_attn_dim", type=int, default=64, help="The dimension of the gru state net")
